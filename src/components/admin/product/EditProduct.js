        ...
        <div className="product-add-new">
          <div className="row">
            <div className="col-md-6">
              <TextFieldGroup field="name" value={this.state.product.name} label="Tên sản phẩm"
                              onChange={this.onInputChange}
                              error={this.state.errors.name}/>
            </div>
            <div className="col-md-6">
              <TextFieldGroup field="price" value={this.state.product.price} label="Đơn giá" type="number"
                              onChange={this.onInputChange} error={this.state.errors.price}/>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6">
              <TextFieldGroup field="quantity" value={this.state.product.quantity} label="So luong" type="number"
                              onChange={this.onInputChange} error={this.state.errors.quantity}/>
            </div>
            <div className="col-md-6">
              <TextFieldGroup field="discount" value={this.state.product.discount} label="Giam gia" type="number"
          ...
          <div className="row">
            <div className="col-md-6">
              <TextFieldGroup field="rating" value={this.state.product.rating} label="Danh gia" type="number"
              ...
              <FormGroup>
                <div>
                  {this.state.image_url === '' ? null :
                    <div>
                      <Image responsive rounded src={this.state.product.image_url}/>
                    </div>}
                </div>
              </FormGroup>
            </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <FormGroup className={this.state.errors.description ? "has-error" : ""}>
                ...
                <FroalaEditor model={this.state.product.description}
          ...
          <div className="row">
            <div className="col-md-12 text-right">
              <RaisedButton secondary={true} label="Sửa" onTouchTap={this.submit}/>
            </div>
          </div>
