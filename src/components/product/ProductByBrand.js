...
export default GuestOrUser(class ProductByBrand extends React.Component {
  constructor(props) {
    super(props);
  ...
  _getState() {
    return {
      products: ProductStore.fetchByBrand(),
  ...
  componentDidMount() {
    ProductService.fetchByBrand(this.state.code);
  }

  componentWillReceiveProps(newProps) {
    ProductService.fetchByBrand(newProps.params.code);
  }
